 ...
 */
final class Version20190812011502 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE codeoperation (id INT AUTO_INCREMENT NOT NULL, operation_id INT NOT NULL, client_id INT NOT NULL, code INT NOT NULL, UNIQUE INDEX UNIQ_CEC09B2619EB6921 (client_id), UNIQUE INDEX UNIQ_CEC09B2644AC3583 (operation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE operation (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, libelle_id INT NOT NULL, date DATETIME NOT NULL, montant INT NOT NULL, frais INT NOT NULL, INDEX IDX_1981A66D25DD318D (libelle_id), INDEX IDX_1981A66DFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
